...
class AdminOrderController extends AdminBase
{
    ...
    public function actionIndex()
    {
        ...
        // Подключаем вид
        require_once(ROOT . '/modules/admin/views/admin_order/index.php');
        return true;
    }
    ...
    public function actionUpdate($id)
    {
        ...
        // Подключаем вид
        require_once(ROOT . '/modules/admin/views/admin_order/update.php');
        return true;
    }
    ...
    public function actionView($id)
    {
        ...
        // Подключаем вид
        require_once(ROOT . '/modules/admin/views/admin_order/view.php');
        return true;
    }
    ...
    public function actionDelete($id)
    {
        ...
        // Подключаем вид
        require_once(ROOT . '/modules/admin/views/admin_order/delete.php');
        return true;
    }
