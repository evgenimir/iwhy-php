...
class Order
{
     ...
     * @param string $userComment <p>Коментарий</p>
     * @param integer $userId <p>ID польщователя</p>
     * @param array $products <p>Заказанные товары</p>
     * @return boolean <p>Результат выполнения метода</p>
     */
    public static function saveOrder($userName, $userPhone, $userComment, $userId, $products)
    {
        // Возвращаем товары строкой
    ...
    public static function getStatusText($status)
    {
        switch ($status) {
            case '1':
                return '<span class="text-danger" style="font-weight: 600;">Новый заказ</span>';
                break;
            case '2':
                return '<span class="text-warning" style="font-weight: 600;">В обработке</span>';
                break;
            case '3':
                return '<span class="text-info" style="font-weight: 600;">Доставляется</span>';
                break;
            case '4':
                return 'Закрыт';
                break;
